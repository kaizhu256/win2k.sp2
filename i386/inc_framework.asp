...
Private Function SAI_EmitWizardHeading(ByVal WizPageID)
	...
	Response.Write(" value='"+Server.HTMLEncode(CStr(WizPageID))+"'>" + vbCrLf)
End Function
...
Private Function SAI_ServeAreaPage(ByRef PageIn, ByRef eventArg)
	...
	Response.Write("<input type='hidden' name='" & SAI_FLD_PAGEKEY & "' value='" & Server.HTMLEncode(SAI_GetPageKey()) & "'>"+vbCrLf)
