...
<%  
        ...
        <form id=sa_formdownload name=sa_formdownload method="POST" target="_self">
            ...
            <table width=518 border=0 cellspacing=0  cellpadding=2 >
                ...
                <tr>
                    ...
                    <input type=hidden name=hdnstrfiletype id=hdnstrfiletype value='<%=Server.HTMLEncode(F_strRadSelected)%>'>
                    </td>
                </tr>
            </table>
        </form>
    ...
    sub getLogEventsTxtCsv()
        ...
        %>
            <script language="javascript">
                top.location.href = '<%=FormatJScriptString(F_strDownloadFile)%>';
            </script>
        <%
