...
%>
		...
		<input type="hidden" name="hidEvent" Value="<%=Server.HTMLEncode(F_strEvent)%>">
		<input type="hidden" name="hidFileSize" Value="<%=Server.HTMLEncode(F_strSize)%>">
		<input type="hidden" name="hidFileCreated" Value="<%=Server.HTMLEncode(F_strCreated)%>">
		<input type="hidden" name="hidFileModified" Value="<%=Server.HTMLEncode(F_strModified)%>">
		<input type="hidden" name="hidFileAccessed" Value="<%=Server.HTMLEncode(F_strAccessed)%>">
		<input type="hidden" name="hidMaxLogsize" Value="<%=Server.HTMLEncode(F_strMaxLogsize)%>">
		<input type="hidden" name="hidOverWritePolicy" Value="<%=Server.HTMLEncode(F_strOverwritePolicy)%>">
		<input type="hidden" name="hidOverWriteOutDated" Value="<%=Server.HTMLEncode(F_strOverwriteOutdated)%>">
<%
