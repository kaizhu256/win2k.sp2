...
Public Function OTS_ServeTaskViewTable(ByRef Table)
	...
	Response.Write("<input type=hidden name='tSelectedItem' value='"+Server.HTMLEncode(Request.Form("tSelectedItem"))+"'>"+vbCrLf)
	Response.Write("<input type=hidden name='tSelectedItemNumber' value='"+Server.HTMLEncode(Request.Form("tSelectedItemNumber"))+"' >"+vbCrLf)
	Response.Write("<input type=hidden name='fldPKeyParamName' value='"+Server.HTMLEncode(sPKeyParamName)+"' >"+vbCrLf)
	...
	Response.Write("<input type=hidden name='"+FLD_PagingPageMin+"' value='"+Server.HTMLEncode(CStr(iPageMin))+"' >"+vbCrLf)
	Response.Write("<input type=hidden name='"+FLD_PagingPageMax+"' value='"+Server.HTMLEncode(CStr(iPageMax))+"' >"+vbCrLf)
	Response.Write("<input type=hidden name='"+FLD_PagingPageCurrent+"' value='"+Server.HTMLEncode(CStr(iPageCurrent))+"' >"+vbCrLf)
	...
	Response.Write("<input type=hidden name='"+FLD_SortingColumn+"' value='"+Server.HTMLEncode(CStr(sortCol))+"' >"+vbCrLf)
	Response.Write("<input type=hidden name='"+FLD_SortingSequence+"' value='"+Server.HTMLEncode(sortSequence)+"' >"+vbCrLf)
...
Private Function OTS_EmitAutoInitJavascript(ByRef table)
	...
	Else
		...
		Response.Write("		// "+vbCrLf)
		Response.Write("		OTS_Init('"+FormatJScriptString(Request.QueryString(sPKeyParamName))+"');"+vbCrLf)
