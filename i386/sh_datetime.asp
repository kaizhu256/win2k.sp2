...
Sub ServePage
	...
	<SCRIPT LANGUAGE=JavaScript>
		...
		{
			timezone = "<% =Server.HTMLEncode(g_sTimeZone) %>";
...
<input name="StandardName" type="hidden" value="<% =Server.HTMLEncode(g_sTimeZone) %>">
<input name="EnableDaylight" type="hidden" value="<% =Server.HTMLEncode(g_sEnableDaylight) %>">
<input name="WasChanged" type="hidden" value="<% =Server.HTMLEncode(g_sWasChanged) %>">
...
<td class="TasksBody">
<input class="FormField" type="text" name="DateID" id=DateID size=20 maxlength=40 value='<%=Server.HTMLEncode(g_sDateID)%>' onkeypress="StopRefresh()">
</td>
</tr>
...
<td class="TasksBody">
<input class="FormField" type="text" name="TimeID" id=TimeID size=20 maxlength=20 value='<%=Server.HTMLEncode(g_sTimeID)%>' onkeypress="StopRefresh()">
</td>
</tr>
...
<tr>
	<td class="TasksBody"><INPUT TYPE='checkbox' <%=Server.HTMLEncode(sEnableDaylightAttr)%> class=FormField name='EnableDaylightCheck' id='EnableDaylightCheck' onclick='StopRefresh()'></td>
...
Function RenderTimezoneList()
    ...
    %>    
		...
		<option id=<%=arrTimezone(i,0)%> value="<%=Server.HTMLEncode(arrTimezone(i,1))%>"		
		<% 
