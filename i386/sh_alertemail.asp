...
%>
		...
		<TABLE   BORDER=0 CELLSPACING=0 CELLPADDING=0 >
			<TR>
				<TD class=TasksBody>
					<INPUT type="RADIO"  class=FormField name="radAlertEmail" value=1 <%=Server.HTMLEncode(aeDisableCheck)%>
			...
			<TR>
				<TD class=TasksBody>
					<INPUT type="RADIO" class=FormField name="radAlertEmail" value=2  <%=Server.HTMLEncode(aeEnableCheck)%>
			...
			<TR>
				...
				<TD class=TasksBody>
					<INPUT type="CHECKBOX" class=FormField <%=Server.HTMLEncode(aeDisableAlertEmail)%> name="chkCritical" 
							<%=Server.HTMLEncode(aeSendCriticalCheck)%>>
					</INPUT>
				</TD>
				<TD class=TasksBody>
			...
			<TR>
				...
				<TD class=TasksBody>
					<INPUT type="CHECKBOX" class=FormField <%=Server.HTMLEncode(aeDisableAlertEmail)%> name="chkWarning"
							<%=Server.HTMLEncode(aeSendWarningCheck)%>>
					</INPUT>
				</TD>
				<TD class=TasksBody>
			...
			<TR>
				...
				<TD class=TasksBody>
					<INPUT type="CHECKBOX" class=FormField <%=Server.HTMLEncode(aeDisableAlertEmail)%> name="chkInformational"
							<%=Server.HTMLEncode(aeSendInforCheck)%>>
					</INPUT>
				</TD>
				<TD class=TasksBody>
			...
			<TR><td></td><td></td><td><table cellpadding=0 cellspacing=0><tr>
				...
				<TD class=TasksBody>
					<INPUT type="TEXT" class=FormField name="txtTargetMailAdress" style="WIDTH:200px"
						<%=Server.HTMLEncode(aeDisableAlertEmail)%> value="<%=Server.HTMLEncode(aeReceiverEmailAddress)%>">
					</INPUT>
				</TD>
			...
			<TR>
				...
				<TD class=TasksBody>
					<INPUT type="TEXT" class=FormField name="txtSmartHost" style="WIDTH:200px"
						   <%=Server.HTMLEncode(aeDisableAlertEmail)%> value="<%=Server.HTMLEncode(aeSmartHost)%>">
					</INPUT>
				</TD>
				<TD noWrap class=TasksBody>
			...
			<TR>
				...
				<!--	<INPUT type="BUTTON" class=TaskFrameButtons name="btnTest" style="WIDTH:100px" <%=Server.HTMLEncode(aeDisableAlertEmail)%>
