...
%>
	            <TABLE WIDTH="400" ALIGN="left" BORDER="0" CELLSPACING="0" CELLPADDING="0"
		            ...
		            <TR>
		                ...
		                <TD CLASS="TasksBody">
							<INPUT TYPE="radio" CLASS="FormRadioButton" NAME="radUploadMethod"
							       VALUE="<%=UPLOADMETHOD_FPSE%>" <%=Server.HTMLEncode(strFPSEAttributes)%>>
		                </TD>
		            ...
		            <TR>
		                ...
		                <TD CLASS="TasksBody">
							<INPUT TYPE="radio" CLASS="FormRadioButton" NAME="radUploadMethod"
							       VALUE="<%=UPLOADMETHOD_FTP%>" <%=Server.HTMLEncode(strFTPAttributes)%>>
		                <TD CLASS="TasksBody" NOWRAP>
		            ...
		            <TR>		
		                ...
		                <TD CLASS="TasksBody">
			                <INPUT TYPE="radio" CLASS="FormRadioButton" NAME="radUploadMethod"
			                       VALUE="<%=UPLOADMETHOD_NEITHER%>" <%=Server.HTMLEncode(strNeitherAttributes)%> ID="Radio1">
		                </TD>
		                <TD CLASS="TasksBody" NOWRAP>
		            ...
		            <TR>
			            <TD CLASS="TasksBody" COLSPAN="3" NOWRAP>
						    <INPUT TYPE="checkbox" CLASS="formField" NAME="chkAllow" VALUE="ON"
						           <%=Server.HTMLEncode(strAnonymousAttributes)%>>
