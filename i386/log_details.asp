...
%>	
		...
		<input type="hidden" name="hdnLogName" value="<%=Server.HTMLEncode(G_strLogName)%>">
		<input id="hdnRecordNum" type="hidden" name="hdnRecordNum" value="<%=Server.HTMLEncode(G_intRecordNumber)%>">
		<input id="hdnMaxRecords" type="hidden" name="hdnMaxRecords" value="<%=Server.HTMLEncode(G_intMaxRecords)%>">
		<input type="hidden" name="hdnMinRecords" value="<%=Server.HTMLEncode(G_intLowestRec)%>">
