...
<% 
	...
	%>	
		...
		<input type="hidden" name="hdnNicID" value="<%= Server.HTMLEncode(F_ID) %>">
		<input type="HIDDEN" name="hdnDNSserverList" value="<%=Server.HTMLEncode(F_DNSserverList)%>">
		<input type="HIDDEN" name="hdnRadioSelected" value="<%=Server.HTMLEncode(F_radSelected)%>">
<%	
