...
<%	
	...
	%>
		<TABLE WIDTH=518 VALIGN=CENTER ALIGN=left BORDER=0 CELLSPACING=0  CELLPADDING=2>
			...
			<tr>
				<td width=25% nowrap class="TasksBody">
					...
					<input type=text name=txtAtTime value="<%= Server.HTMLEncode(F_strScheduledTime) %>" maxlength=12 size=15>
				</td>				
			</tr>
			<tr>
				<td class="TasksBody">
		...
		<input type = hidden name = "hdnrdoschedule" value="<%=Server.HTMLEncode(F_strScheduleAction)%>">
		<input type = hidden name = "hdnrdoScheduleDate" value="<%=Server.HTMLEncode(F_strScheduledOption)%>">
		<input type = hidden name = "hdnoptMinutes" value="<%=Server.HTMLEncode(F_strMinutes)%>">
		<input type = hidden name = "hdnoptHours" value="<%=Server.HTMLEncode(F_strHours)%>">
		<input type = hidden name = "hdnoptDays" value="<%=Server.HTMLEncode(F_strDays)%>">		
		<input type = hidden name = "hdnchkSendMessage" value="<%=Server.HTMLEncode(F_chkSendMessage)%>">
		<input type = hidden name = "hdntxtAtTime" value="<%=Server.HTMLEncode(F_strScheduledTime)%>">
		<input type = hidden name = "hdnselWeekDay" value="<%=Server.HTMLEncode(F_strSelectedWeekDay)%>">
	<%
	End Function
