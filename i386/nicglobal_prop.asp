			...
			<table valign="middle" align="left" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>	
					<td align="left" colspan="3" class="TasksBody">
						<input type=radio class="FormRadioButton" <%=Server.HTMLEncode(F_strPrimaryChecked) %>  value="PRIMARY" name="radDNSSUFFIX" onclick="OnRadioClick(this);">&nbsp;<%=L_APPEND_PRIMARYDNSSUFFIX%>
					</td>
				</tr>
				<tr>
					<td class="TasksBody">
					...
					<td align="left" colspan="2" class="TasksBody">
						<input type="checkbox" class="FormCheckBox" onclick="SetPageChanged(true);" <%=Server.HTMLEncode(F_strAppendDNSSuffix_EditStatus)%>   value="PRIMARYANDPARENT"  <%=F_strPrimaryAndParentChecked%> name="chkAPPENDDNSSUFFIX" >
						&nbsp;<%=L_APPEND_PRIMARYDNSSUFFIX_AND_PARENTSUFFIXES%>
					</td>
				</tr>
				<tr>
					<td colspan="3" class="TasksBody">
						<input type=radio class="FormRadioButton" <%=Server.HTMLEncode(F_strDNSSuffixesChecked)%> value="SPECIFIC"  name=radDNSSUFFIX onclick="OnRadioClick(this); document.frmTask.txtDomainSuffix.focus()" >&nbsp;<%=L_APPEND_DNSSUFFIXES%>
					</td>
				</tr>
				<tr>
					<td  class="TasksBody">
				...
				<input type="hidden" name="hdnradDNSPrimaryChecked" value="<%=Server.HTMLEncode(F_strPrimaryChecked)%>" >
				<input type="hidden" name="hdnradDNSSuffixChecked" value="<%=Server.HTMLEncode(F_strDNSSuffixesChecked)%>">
				<input type="hidden" name="hdnchkAppendDNSSuffix" value="<%=Server.HTMLEncode(F_strPrimaryAndParentChecked)%>" >
			...
			<table valign="middle" align="left" border=0 cellspacing="0" cellpadding="0">
				...
				<tr>
					<td colspan="4" class="TasksBody">
						<input type="checkbox" class="FormCheckBox" name="chkLMHOSTSLOOKUP" <%=Server.HTMLEncode(F_strLMHOSTSLOOKUPSTATUS)%> value="<%=Server.HTMLEncode(F_strLMHOSTSLOOKUP)%>" onclick="EnableLMHostText()" >&nbsp;&nbsp;<%=L_ENABLED_LMHOSTS_LOOKUP%> 
					</td>
					
				</tr>
				<tr>		
					<td colspan="4" class="TasksBody">
						<textarea  class="FormField" wrap="off"  name="txaLMHOSTS" <%=Server.HTMLEncode(F_strLMHOSTS_EDITSTATUS)%> rows="12" cols="80" onfocus=HandleKey("DISABLE") onblur=HandleKey("ENABLE") ><%=Server.HTMLEncode(F_strLMHOSTS)%></textarea>
					</td>
				</tr>
				<tr>
					<td colspan="4" class="TasksBody">
				...
				<input type="hidden" name="hdnLMHOSTS" value="<%=Server.HTMLEncode(F_strLMHOSTS_EDITSTATUS)%>">	
			</table>
<%
		Else 
%>
