		...
		%>
			...
			<table width=518 valign=middle align=left border=0 cellspacing=0
				...
				<tr>
					...
					<td>
					    <input TYPE="checkbox" value='1' <%=server.HTMLEncode(F_strHDIschecked)%> class="FormCheckBox" NAME="chkHomePath" onclick="checkClick()">
					    <% =L_HOMEPATH_TEXT %>
					    &nbsp;&nbsp;
				...
				<tr>
					...
					<td>
						<input TYPE="checkbox" value='1' <%=server.HTMLEncode(F_strIschecked)%> class="FormCheckBox" NAME="chkUserDisabled">
						<%=L_USERDISABLED_TEXT	%>
					</td>
				</tr>
