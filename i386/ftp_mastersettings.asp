...
%>
		...
		<TABLE border=0 cellPadding=1 cellSpacing=1 style="LEFT: 12px; TOP: 15px" class="TasksBody">
			...
			<TR>
				...
				<TD>
				    ...
				    <SELECT  name=selectDirListStyle style="HEIGHT: 22px; WIDTH: 85px" tabIndex=3 class="formField" value="<%=Server.HTMLEncode(F_selectDirListStyle)%>">
			...
			<TR>
				...
				<TD>								
				    <INPUT name=txtMaxCon  size=10  class="formField" tabIndex=4 value="<%=Server.HTMLEncode(F_FTPMaxCon)%>" OnKeyUP="javaScript:checkUserLimit(this,'conftp');" OnKeypress="javaScript:checkKeyforNumbers(this);" onblur = "checkforEmptyMaxCon();">				                    
				</TD>
			</TR>
			...
			<TR>
				...
				<TD>
					<INPUT name=txtConTimeOut size=10  class="formField" tabIndex=5 value="<%=Server.HTMLEncode(F_FTPCon_Timeout)%>" OnKeyUP="javaScript:checkUserLimit(this,'contimeout');" OnKeypress="javaScript:checkKeyforNumbers(this);" onblur = "checkforEmptyConTimeOut()">					
				</TD>
			</TR>
		...
		<input type=hidden name=hdnFTPMaxCon value = "<%=Server.HTMLEncode(F_FTPMaxCon)%>" >
		<input type=hidden name=hdnFTPConTimeout value = "<%=Server.HTMLEncode(F_FTPCon_Timeout)%>" >
		<input type=hidden name=hdnFTPListStyle value = "<%=Server.HTMLEncode(F_selectDirListStyle)%>" >
