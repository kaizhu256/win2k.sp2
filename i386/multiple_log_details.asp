...
<%
	...
	Public Function OnServeAreaPage(ByRef PageIn, ByRef EventArg)
		...
		Call OTS_AddTableTask( table, OTS_CreateTaskEx(L_VIEW_TEXT, _
										L_VIEW_TEXT, _
										"logs/Single_Log_Details.asp?" & "logtitle=" & Server.URLEncode(L_PAGETITLE_LOGS_TEXT) & "&tab1=" & Server.URLEncode(GetTab1()) & "&tab2=" & Server.URLEncode(GetTab2()) ,_
										OTS_PT_AREA,_
										"OTS_TaskOne") )			
				
		Call OTS_AddTableTask( table, OTS_CreateTaskEx(L_CLEAR_TEXT, _
										L_CLEAR_TEXT, _
										"logs/Text_Log_clear.asp?FilePath="& G_strLogFilePath & "&tab1=" & Server.URLEncode(GetTab1()) & "&tab2=" & Server.URLEncode(GetTab2()),_
