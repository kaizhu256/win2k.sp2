...
%>
			...
			<TABLE VALIGN=middle BORDER=0 CELLSPACING=0 CELLPADDING=2 class="TasksBody">
				<TR>
					...
					<TD><INPUT class ="FormField" TYPE = "text" STYLE="WIDTH:180px" Name ="txtCredentialID" value="<%=Server.HTMLEncode(F_strCredentialID)%>" ></TD>
				</TR>
				<TR>
					<TD><%=Server.HTMLEncode(L_PASSWORD_PROMPT_TEXT)%></TD>
					<TD><INPUT class ="FormField" TYPE = "password" STYLE="WIDTH:180px" Name ="txtCredentialPSW" value="<%=Server.HTMLEncode(F_strCredentialPSW)%>"></TD>
				</TR>
