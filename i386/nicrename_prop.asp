...
<% 
    ...
    Public Function OnServePropertyPage(ByRef PageIn,Byref EventArg)
        ...
        <TABLE WIDTH=518 VALIGN=CENTER ALIGN=left BORDER=0 CELLSPACING=0 CELLPADDING=2 class="Tasksbody">
            ...
            <TR>
                <td nowrap COLSPAN=4><B><%=Server.HTMLEncode(G_strConnName)%></B></td>
            </TR>
            ...
            <TR>
                ...
                <TD NOWRAP>
                    <input NAME="txtConnectionName" TYPE="text" SIZE="30" maxlength=284 VALUE="<%=Server.HTMLEncode(G_strConnName)%>"> 
                </TD>
            </TR>
