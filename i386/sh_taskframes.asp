...
Else
	Response.Write(Server.HTMLEncode(UTF8ToUnicode(Request.QueryString("Title"))))
End If
%>
</title>
<!-- Copyright (c) Microsoft Corporation.  All rights reserved.-->
...
%>
  <frameset rows="*,75" framespacing=0 border="false" frameborder="0">
	<frame name="main" scrolling="yes" src="<%=Server.HTMLEncode(strURL)%>" noresize marginwidth="0" marginheight="0">
