...
<% 
    ...
    Private Function ServeTabGeneral(ByRef PageIn, ByVal bIsVisible)
        ...
        Else
            ...
            Response.Write("<input type=hidden name=hdnDeviceID value="""+ Server.HTMLEncode(g_strDeviceID) +""" >")

            Response.Write("<input type=hidden name=hdnGeneralTabValue value="""+ Server.HTMLEncode(g_strTabValue) +""" >")

            Response.Write("<input type=hidden name=txtIP value="""+ Server.HTMLEncode(F_strIPAddress) +""" >")

            Response.Write("<input type=hidden name=txtGateway value="""+ Server.HTMLEncode(F_strGatewayAddress) +""" >")

            Response.Write("<input type=hidden name=txtMask value="""+Server.HTMLEncode(F_strSubnetMask) +""" >")

            Response.Write("<input type=hidden name=hdnRadIP value="""+Server.HTMLEncode(F_strRadIP) +""" >")
    ...
    Private Function ServeTabAdvanced(ByRef PageIn, ByVal bIsVisible)
        ...
        Else
            ...
            Response.Write("<input type=hidden name=txtConnectionMetric value="""+Server.HTMLEncode(F_nConnectionMetric) +""" >")

            Response.Write("<input type=hidden name=hdnlstIP value="""+Server.HTMLEncode(F_strListIP) +""">")

            Response.Write("<input type=hidden name=hdnlstGATEWAY value="""+Server.HTMLEncode(F_strListGateway) +""" >")

            Response.Write("<input type=hidden name=hdnAdvancedTabValue value="""+Server.HTMLEncode(g_strAdvTabValue)+""">")         
    ...
    %>
...

        {
            ...
            var OptionSel = "<%=Server.HTMLEncode(F_strRadIP) %>";         
...
<%
    ...
    Function ServeGeneralUI()
        ...
        if trim(g_strTabValue) = "" or blnDHCPEnabled then
            ...
            <TR>
                ...
                <TD ALIGN=left class="TasksBody">
                    ...
                    %>
                                ...
                                <INPUT CLASS='FormField' TYPE="TEXT" NAME="txtIP" VALUE="<%=Server.HTMLEncode(F_strIPAddress) %>" TABINDEX=2  MAXLENGTH=15 OnKeyPress="if(window.event.keyCode == 13) return true ; checkKeyforIPAddress(this);">
                        ...
                        %>
                                ...
                                <INPUT CLASS='FormField' TYPE="TEXT" NAME="txtIP" VALUE="<%=Server.HTMLEncode(F_strIPAddress) %>" disabled TABINDEX=2  MAXLENGTH=15 OnKeyPress="if(window.event.keyCode == 13) return true ; checkKeyforIPAddress(this);">
            ...
            <TR>
                ...
                <TD ALIGN=left class="TasksBody">
                    ...
                    %>
                                ...
                                <INPUT CLASS='FormField' TYPE="TEXT" NAME="txtMask" VALUE="<%=Server.HTMLEncode(F_strSubnetMask)%>"  TABINDEX=3 MAXLENGTH=15 OnKeyPress=" if(window.event.keyCode == 13) return true ; checkKeyforIPAddress(this);">
                    ...
                    %>          
                                ...
                                <INPUT CLASS='FormField' TYPE="TEXT" NAME="txtMask"  VALUE="<%=Server.HTMLEncode(F_strSubnetMask)%>" disabled TABINDEX=3 MAXLENGTH=15 OnKeyPress=" if(window.event.keyCode == 13) return true ; checkKeyforIPAddress(this);">
            ...
            <TR>
                ...
                <TD ALIGN=left class="TasksBody">   
                    ...
                    %>      
                                ...
                                <INPUT CLASS='FormField' TYPE="TEXT" NAME="txtGateway" VALUE="<%=Server.HTMLEncode(F_strGatewayAddress)%>" TABINDEX=3 MAXLENGTH=15 OnKeyPress=" if(window.event.keyCode == 13) return true ; checkKeyforIPAddress(this);">
                    ...
                    %>          
                                ...
                                <INPUT CLASS='FormField' TYPE="TEXT" DISABLED NAME="txtGateway" VALUE="<%=Server.HTMLEncode(F_strGatewayAddress)%>" TABINDEX=3 MAXLENGTH=15 OnKeyPress=" if(window.event.keyCode == 13) return true ; checkKeyforIPAddress(this);">
            ...
            <INPUT TYPE=hidden NAME=hdnInitialIPValue VALUE="<%= Server.HTMLEncode(g_initialIPAddress)  %>">
...
%>              
            ...
            <TR>            
                ...
                <INPUT TYPE="TEXT" NAME="txtConnectionMetric" TABINDEX=12 SIZE=15 MAXLENGTH=4 VALUE="<%=Server.HTMLEncode(F_nConnectionMetric)%>" OnKeyPress="checkKeyforNumbers(this)">
        ...
        <INPUT TYPE=hidden NAME=hdnlstIP VALUE="<%=Server.HTMLEncode(F_strListIP)%>">

        <INPUT TYPE=hidden NAME=hdnlstGATEWAY VALUE="<%=Server.HTMLEncode(F_strListGateway)%>">

        <INPUT TYPE=hidden NAME=hdnAdvancedTabValue VALUE="<%= Server.HTMLEncode(g_strAdvTabValue) %>">
