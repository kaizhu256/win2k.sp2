...
<%	
	...
	%>	
		...
		<input name="hdnServerslist" type="Hidden" value="<%=Server.HTMLEncode(F_strWinservers)%>" >
		<input name="hdnNWAdapterID" type="Hidden" value="<%=Server.HTMLEncode(F_nNWadapterindex)%>" >
		<input name="hdnRadioSelected" type="hidden"  value="<%=Server.HTMLEncode(F_radSelected)%>">
